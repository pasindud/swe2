...
public class AppBeanInfo extends SimpleBeanInfo {
  ...
  private static BeanDescriptor getBdescriptor() {
    BeanDescriptor beanDescriptor =
        new BeanDescriptor(com.app.App.class, null); // NOI18N//GEN-HEADEREND:BeanDescriptor
  ...
  private static MethodDescriptor[] getMdescriptor() {
    ...
    try {
      methods[METHOD_main0] =
          new MethodDescriptor(
              com.app.App.class.getMethod(
                  "main", new Class[] {java.lang.String[].class})); // NOI18N
