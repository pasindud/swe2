...
public class ExchangeRates {
   ...
   * @return if sucessfully it returns the exchange rate for the given currencies or throws the
   *     relavent exception.
   */
  public static float getExchangeRate(String fromCurrency, String toCurrency) throws Exception {
    ...
    try {
      ...
      logger.info(
          String.format(
              "Exchange rate for %s to %s is %f", fromCurrency, toCurrency, exchangeRate));
      return exchangeRate;
