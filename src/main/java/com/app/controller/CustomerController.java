...
public class CustomerController {
    ...
    Object getOneCustomer(@RequestParam("id") Integer id){
        return jdbcTemplate.queryForObject("select * from customer where userId=?", new Object[id], new customerRowMapper());
    }
    ...
    Object getCustomers(@RequestParam("id") Integer id, HttpSession session){
        ...
        return customerRepository.findByUserid(customer);
    }
